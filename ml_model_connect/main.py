...
class UserInput(BaseModel):
    ...
    occupation: Annotated[Literal['retired', 'unemployed', 'engineer', 'businessman', 'teacher', 'manager', 'student', 'doctor',  'software_engineer', 'accountant', 'freelancer', 'nurse'], Field(...,  description='Age of the user')]
...
@app.post('/predict')
def predict_preminum(data: UserInput):
